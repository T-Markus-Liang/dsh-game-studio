...
- **CONCERNS** → surface the specific ADRs or recommendations flagged; use `通过宿主 ask 机制向用户提问` with options: `Revise the impact assessment` / `Accept with noted concerns` / `Discuss further`

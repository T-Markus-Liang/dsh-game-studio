...
Read the relevant agent definition from `assets/agents/` if a specific role is specified.
...
- Run `/game help` if the contributor needs guidance on what to work on next.

...
Read the `Engine Specialists` section of `assets/docs/technical-preferences.md`
...
5. **Engine preferences**: `assets/docs/technical-preferences.md` — read naming conventions and performance budgets

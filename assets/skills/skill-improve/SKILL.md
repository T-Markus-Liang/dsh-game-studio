...
Verify `assets/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `assets/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `assets/skills/[name]/SKILL.md`?"
...
Write the improved skill to `assets/skills/[name]/SKILL.md`.
...
Ask: "May I revert `assets/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- assets/skills/[name]/SKILL.md`

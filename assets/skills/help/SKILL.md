...
Read `assets/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `assets/skills/*/SKILL.md` to get the full list
...
- `/game start` — re-orient from scratch
```

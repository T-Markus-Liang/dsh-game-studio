...
1. Check `assets/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `assets/docs/templates/patch-notes-template.md`.

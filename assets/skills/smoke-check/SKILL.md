...
3. **Engine detection**: read `assets/docs/technical-preferences.md` and
...
"Engine not configured in `assets/docs/technical-preferences.md`. Run
...
Use `the host's ask/question mechanism` to batch-verify. Keep to at most 3 calls.
...
- Use `the host's ask/question mechanism` for all manual smoke check verification.

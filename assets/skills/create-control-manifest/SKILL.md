...
- Read `assets/docs/technical-preferences.md`
...
Spawn `technical-director` via Task using gate **TD-MANIFEST** (`assets/docs/director-gates.md`).
...
- **CONCERNS** → surface via `the host's ask/question mechanism` with options: `Revise flagged rules` / `Accept and proceed` / `Discuss further`

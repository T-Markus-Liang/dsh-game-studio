...
Context is the most critical resource in a DSH session. Manage it actively.
...
Maintain `.dsh/game-studio/state/active.md` as a living checkpoint. Update it
...
- Reference to `.dsh/game-studio/state/active.md` (read it to recover state)
...
**After compaction:** Read `.dsh/game-studio/state/active.md` and any files being

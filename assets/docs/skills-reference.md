...
73 slash commands organized by phase. Type `/` in DSH to access any of them.

## Onboarding & Navigation

| Command | Purpose |
|---------|---------|
| `/game start` | First-time onboarding — asks where you are, then guides you to the right workflow |
| `/game help` | Context-aware "what do I do next?" — reads current stage and surfaces the required next step |

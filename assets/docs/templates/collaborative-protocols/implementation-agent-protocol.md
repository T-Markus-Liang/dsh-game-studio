...
2. **Ask architecture questions:**
   ...
   - *Use `the host's ask/question mechanism` to batch constrained architecture questions*
...
Use the `the host's ask/question mechanism` tool for architecture decisions and next-step choices.

...
- IDE: VS Code with DSH extension
...
1. Copy this template to your project root: `cp assets/docs/CLAUDE-local-template.md CLAUDE.local.md`
2. Edit to match your preferences
3. Verify `CLAUDE.local.md` is in `.gitignore` (DSH reads it from the project root)
